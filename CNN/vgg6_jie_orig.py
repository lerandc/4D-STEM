...
def main():
    ...
    input_folder = 'G:/jfeng_MSCdata_data/cbed/s8_ph0/s8_ph0_Ti_pacbed_1111_npy_noise_peak_100/'
    result_path = 'G:/jfeng_MSCdata_data/cbed/s8_ph0/s8_ph0_Ti_pacbed_1111_npy_noise_peak_100/results/'
...
def save_bottleneck_features(x_train, y_train, batch_size, nb_train_samples):
    ...
    np.save('G:/jfeng_MSCdata_data/cbed/s8_0_0_Ti_pacbed_r7_npy/results/bottleneck_features_train.npy',
            bottleneck_features_train)

def train_top_model(y_train, nb_class, max_index, epochs, batch_size, input_folder, result_path):
    train_data = np.load('G:/jfeng_MSCdata_data/cbed/s8_0_0_Ti_pacbed_r7_npy/results/bottleneck_features_train.npy')
    ...
    bottleneck_log = 'G:/jfeng_MSCdata_data/cbed/s8_0_0_Ti_pacbed_r7_npy/results/' + 'training_' + str(max_index) + '_bnfeature_log.csv'
...
def fine_tune(x_train, y_train, sx, sy, max_index, epochs, batch_size, input_folder, result_path):
    ...
    fineture_log = 'G:/jfeng_MSCdata_data/cbed/s8_0_0_Ti_pacbed_r7_npy/results/' + 'training_' + str(max_index) + '_finetune_log.csv'
    ...
    new_model.save('G:/jfeng_MSCdata_data/cbed/s8_0_0_Ti_pacbed_r7_npy/results/FinalModel.h5')  # save the final model for future loading and prediction
